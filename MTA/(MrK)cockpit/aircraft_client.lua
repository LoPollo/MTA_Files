...
attitudeIndicator = dxCreateTexture(":(MrK)cockpit/grafik/attitude_indicator.png" , "argb", true,"clamp" )
altimeter1 = dxCreateTexture(":(MrK)cockpit/grafik/altimeter_1.png" , "argb", true,"clamp" )
variometer = dxCreateTexture(":(MrK)cockpit/grafik/variometer.png" , "argb", true,"clamp" )
altimeterPointer1 = dxCreateTexture(":(MrK)cockpit/grafik/altimeter_pointer_1.png" , "argb", true,"clamp" )
altimeterPointer2 = dxCreateTexture(":(MrK)cockpit/grafik/altimeter_pointer_2.png" , "argb", true,"clamp" )
airspeedIndicator = dxCreateTexture(":(MrK)cockpit/grafik/airspeed_indicator.png" , "argb", true,"clamp" )
compass1 = dxCreateTexture(":(MrK)cockpit/grafik/compass_1.png" , "argb", true,"clamp" )
compass2 = dxCreateTexture(":(MrK)cockpit/grafik/compass_2.png" , "argb", true,"clamp" )
corner1 = dxCreateTexture(":(MrK)cockpit/grafik/corner_1.png" , "argb", true,"clamp" )
corner2 = dxCreateTexture(":(MrK)cockpit/grafik/corner_2.png" , "argb", true,"clamp" )
ledon = dxCreateTexture(":(MrK)cockpit/grafik/led_on.png" , "argb", true,"clamp" )
ledoff = dxCreateTexture(":(MrK)cockpit/grafik/led_off.png" , "argb", true,"clamp" )
end
