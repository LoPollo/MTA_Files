...
mode="off"
addEvent(name.."startAI",true)

function targetingActivated ( weapon,ammo,ammoInClip,hitX,hitY,hitZ,target )
	triggerServerEvent(name.."explode",source,hitX,hitY,hitZ,target,source,weapon,ammo,ammoInClip)
end
...
addEventHandler(name.."startAI",getLocalPlayer(),ai)